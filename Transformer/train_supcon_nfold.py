...
def create_model(args, input_dim, use_supcon):
...
def train_fold(fold, train_files, val_files, args, output_dir, use_supcon, input_dim):
    """Train a single fold"""
    print("\n" + "="*60)
    ...
    # Create model
    model = create_model(args, input_dim, use_supcon)
...
def main():
    ...
    for fold in range(args.n_folds):
        ...
        best_val_acc, history = train_fold(
            fold, train_files, val_files, args, output_dir, use_supcon, input_dim
        )
